			...
			<div className='container'>
				<div className='footer__wrapper mb-20 '>
					<div className='footer__block-one'>
						...
						<div className='footer__block-title'>
							<h6 className='footer__sub-title'>Верся сайта: 0.1</h6>
						</div>
					</div>
					<div className='footer__block-two'>
						<div className='social-icons'>
							<Link
								className='linck'
								to='https://discord.com/invite/C7gGFrCaXb'
							>
								<i className='bx bxl-discord-alt'></i>
							</Link>
							<Link to='https://vk.com/ffworlds'>
								<i className='bx bxl-vk'></i>
							</Link>
							<Link to='https://github.com/Foksif'>
				...
				<div className='footer__wrapper'>
					<div className='footer__wrapper'>
						<p className='scroll-scale'>
							Copyright &copy; 2020 - 2024 by Foks_f || All rights reserved.
						</p>
						<a className='scroll-scale lincks' href='#home'>
