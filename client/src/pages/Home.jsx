			...
			<section className='intro'>
				<div className='container'>
					<h1 className='intro__title'>
						F-WORLDS - Сервер с упором на{' '}
						<span className='intro__title-colored'>
							ванильное выживание и щепотку RolePlay'a.
						</span>
					</h1>
					...
					<div className='btn-intr-wrap'>
						<div className='intro__buttons'>
							<button onClick={() => setModalActive(true)} className='button'>
								<i className='bx bxs-wallet-alt'> </i> Приобрести проходку на
								сервер
							</button>
							<button onClick={cliced} className='button gray'>
								<i className='bx bxs-copy'></i> Скопировать Ip
							</button>
						</div>
					</div>
					...
					<div className='intro__suptitle'>
						<div>
							<p>Minecraft: Java Edition 1.21.1</p>
						</div>
						<div className='curcle'></div>
						<div>
							<p>Лицензия не требуется</p>
						</div>
					</div>
				</div>
			</section>
					...
					<div className='wrap'>
						<div className='informBlock'>
							...
							<p className='secondText'>
								Имеем стабильный ТПС в Minecraft, что дает нашим игрокам игру
								без инпут лагов
							</p>
						</div>
						<div className='informBlock'>
							...
							<div className='underlineBlock'></div>
							<p className='secondText'>
								Команда администрации поможет вам в любое время и ответит на
								любой вопрос.
							</p>
						</div>
						<div className='informBlock'>
							...
							<div className='underlineBlock'></div>
							<p className='secondText'>
								Игроки дружелюбные что дает полное сохранность ваших построек,
								вещей, имуществ
							</p>
						</div>
					</div>
					...
					<div className='server-wrap'>
						<div className='server__block'>
							<div className='server__block-one'>
								<h3>
									<span className='about__title-colored'>120 &#8381;</span>
								</h3>
								<p>На всё время</p>
								<div className='server__but-pos'>
									<div className='intro__buttons'>
										<button
											...
											className='button'
										>
											<i className='bx bxs-wallet-alt'> </i> Приобрести вход на
											сервер
										</button>
									</div>
								</div>
							...
							<div className='server__block-two'>
								<div className='server__text-block'>
									<div className='server__icon'>
										...
										<h6>Доступ на всё время</h6>
									</div>
									<div className='server__text'>
										<p>
											После приобретения, вы получаете доступ на всё время,
								...
								<div className='server__text-block'>
									...
									<div className='server__text'>
										<p>
											Если у вас возникли какие-то проблемы с оплатой или
											появились вопросы вы можете обратится в тех поддержку в
											нашем дискорде!
										</p>
									</div>
								</div>
								...
								<div className='server__text-block'>
									<div className='server__icon'>
										...
										<h6>Только Minecraft: Java Edition</h6>
									</div>
									<div className='server__text'>
										<p className='tst'>
											Для игры на сервере лицензия Minecraft: Java Edition не
											требуется!
										</p>
										<p className='tst'>
											Bedrock Edition и Windows 10 Edition не поддерживаются!
										</p>
										<p>Версия сервера только 1.21.1</p>
									</div>
								</div>

								<div className='server__text-block'>
									<div className='server__text'></div>
								</div>
							</div>
						</div>
					</div>
			...
			<Modal active={modalActive} setActive={setModalActive}>
				<form className='donate-form'>
					<div className='donate-form-wrap'>
						...
						<button disabled={!formValid} onClick={byItem} className='form-btn'>
							Приобрести
						</button>

						{userDirty && userError && (
							<div style={{ color: 'red', marginTop: '15px' }}>{userError}</div>
						)}
						{userDirty && Errors && (
